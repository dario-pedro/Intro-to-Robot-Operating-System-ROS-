...
if("TRUE" STREQUAL "TRUE")
  set(t2_package_SOURCE_PREFIX /home/dario/trsa_ws/src/t2_package)
  set(t2_package_DEVEL_PREFIX /home/dario/trsa_ws/devel)
  ...
  set(t2_package_INSTALL_PREFIX /home/dario/trsa_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 't2_package' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dario <dario@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 't2_package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dario/trsa_ws/src/t2_package/${idir}'.  Ask the maintainer 'dario <dario@todo.todo>' to fix it.")
    endif()
