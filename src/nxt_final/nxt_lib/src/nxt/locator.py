...
name, strict, or method) are provided."""
    ...
    method.bluetooth=False;
    method.fantom=False;
    method.fantombt=False;
    method.fantomusb=False;

    if debug:
        os.system('cls' if os.name == 'nt' else 'clear')
        print "Searching LEGO NXT bricks...\n"
        print "Filter Parameters:\n------------------"
        print "Host: %s\nName: %s\nStrict: %s\n" % (host, name, str(strict))
        print "Connection method:"
        print "========================================================"
        print "USB:\t\t%s\nBluetooth:\t%s\nFantom:\t\t%s" % (method.usb, method.bluetooth, method.fantom)
        print "========================================================\n"
