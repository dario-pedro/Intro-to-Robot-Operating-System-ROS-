...
(cl:defmethod cl:initialize-instance :after ((m <jointState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'jointState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_commander-msg:<jointState> is deprecated: use motor_commander-msg:jointState instead.")))

(cl:ensure-generic-function 'motorID-val :lambda-list '(m))
(cl:defmethod motorID-val ((m <jointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_commander-msg:motorID-val is deprecated.  Use motor_commander-msg:motorID instead.")
  (motorID m))
...
(cl:defmethod velocity-val ((m <jointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_commander-msg:velocity-val is deprecated.  Use motor_commander-msg:velocity instead.")
  (velocity m))
