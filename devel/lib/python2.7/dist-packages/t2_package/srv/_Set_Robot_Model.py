...
"""autogenerated by genpy from t2_package/Set_Robot_ModelRequest.msg. Do not edit."""
import sys
...
class Set_Robot_ModelRequest(genpy.Message):
  ...
  _type = "t2_package/Set_Robot_ModelRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from t2_package/Set_Robot_ModelResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import t2_package.msg
import std_msgs.msg

class Set_Robot_ModelResponse(genpy.Message):
  _md5sum = "0c6e7b025d512f0c651bae0b3614dcd7"
  _type = "t2_package/Set_Robot_ModelResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """t2_package/robot_id robotID
...
"""
  __slots__ = ['robotID']
  _slot_types = ['t2_package/robot_id']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.robotID is None:
        self.robotID = t2_package.msg.robot_id()
    else:
      self.robotID = t2_package.msg.robot_id()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.robotID.header.seq, _x.robotID.header.stamp.secs, _x.robotID.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_b.pack(self.robotID.id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robotID.header.seq, _x.robotID.header.stamp.secs, _x.robotID.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.robotID.id,) = _struct_b.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
class Set_Robot_Model(object):
  _type          = 't2_package/Set_Robot_Model'
