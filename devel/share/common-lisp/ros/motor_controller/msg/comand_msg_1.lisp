...
(cl:defmethod cl:initialize-instance :after ((m <comand_msg_1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'comand_msg_1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_controller-msg:<comand_msg_1> is deprecated: use motor_controller-msg:comand_msg_1 instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <comand_msg_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_controller-msg:mode-val is deprecated.  Use motor_controller-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'motor-val :lambda-list '(m))
(cl:defmethod motor-val ((m <comand_msg_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_controller-msg:motor-val is deprecated.  Use motor_controller-msg:motor instead.")
  (motor m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <comand_msg_1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_controller-msg:position-val is deprecated.  Use motor_controller-msg:position instead.")
  (position m))
